...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                uax = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,77))+'.0.0.'+str(random.randint(1111,7777))+';FBBV/'+str(random.randint(1111111,7777777))+';[FBAN/FB4A;FBAV/38.0.0.7795;FBBV/5829021;FBDM/{density=,,width=720,height=1280};FBLC/en_US;FBRV/5653088;FBCR/null;FBMF/Huawei;FBBD/Huawei;FBPN/com.facebook.lite;FBDV/P20 Lite;FBSV/5.1.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
