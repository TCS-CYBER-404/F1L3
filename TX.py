...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                uax = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,77))+'.0.0.'+str(random.randint(1111,7777))+';FBBV/'+str(random.randint(1111111,7777777))+';[FBAN/FB4A;FBAV/170.0.0.28.15;FBBV/741477382;FBRV/0;FBPN/com.facebook.katana;FBLC/da_DK;FBMF/Oppo;FBBD/Oppo;FBDV/L178 Max;FBSV/13;FBCA/armeabi-v8a:armeabi;FBDM/{density=2.0,width=720,height=1440};FB_FW/1;]'
