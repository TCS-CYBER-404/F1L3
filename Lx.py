...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                uax = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,77))+'.0.0.'+str(random.randint(1111,7777))+';FBBV/'+str(random.randint(1111111,7777777))+';[FBAN/FB4A;FBAV/445.0.0.34.118;FBBV/448014984;FBDM/{density=3.5,width=1440,height=2792};FBLC/en_GB;FBRV/0;FBCR/Grameenphone;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G955FD;FBSV/1.1.1;FBOP/8;FBCA/armeabi-v7a:armeabi;]'
